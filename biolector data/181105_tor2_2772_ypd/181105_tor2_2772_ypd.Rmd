...
f_save<-function(plot,name){
  ...
  print(plot)
  ggsave(filename=paste(name,".jpeg"),path="C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/nov18/181105_tor2_biolector_2772_ypd",height=6, width=9.04)
}
