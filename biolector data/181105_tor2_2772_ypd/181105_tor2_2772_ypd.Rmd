...
f_save<-function(plot,name){
  ...
  print(plot)
  ggsave(filename=paste(name,".jpeg"),path="C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/nov18/181105_tor2_biolector_2772_ypd",height=6, width=9.04, units="cm")
}
...
f_save_pdf<-function(plot,name){
  ...
  print(plot)
  ggsave(filename=paste(name,".pdf"),path="C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/nov18/181105_tor2_biolector_2772_ypd",height=6, width=9.04, units = "cm")
}
...
tor2_final<-f_final_plot(list_melted_tor_dosed,c(0,30,60,200,600))
parent_final<-f_final_plot(list_melted_parent_dosed,c(0,30,60,200,600))
...
f_plot_combined<-function(dataframe1, dataframe2, doses_to_plot1, doses_to_plot2){
  ...
  pretty_plot<-plot +   
    ...
    guides(colour=guide_legend(title = "aTc [ng/mL]",ncol=3,  title.position = "top"),
           linetype=guide_legend(title = "Strain", ncol=1, title.position = "top")) +
...
colour_palette_final<-c("#9AD2F4","#92ADDB","#898FC3","#857EAA","black")
combined_final<-f_plot_combined(list_melted_tor_dosed,list_melted_parent_dosed,c(0,5,60,200,600),c(0,600))
