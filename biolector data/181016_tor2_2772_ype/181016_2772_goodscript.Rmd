...
output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/paper/figures/titration/2772_ype" #where to save the plots

OFFSET<-TRUE # decide if you want to offset all curves by their minimum measured value, such that all curves start around 0.

name_experimental_strain<- "TOR2_gk_ype"
...
biolector_data<- 
  as.data.frame(read.csv("181016_tor2_2772_ype.csv")) %>% # read in the biolector file, from which the rows where the experiment is described is removed (so the first row is the column names)
...
doses_experiment_strain<-c(0,15,30,200,600)
...
f_plot(biolector_data_selected, c(10,35),c(0,70),colour_scale2) +
  scale_x_continuous(limits = c(70,190), breaks = seq(70,190,30), labels=seq(70,190,30)-70) +
