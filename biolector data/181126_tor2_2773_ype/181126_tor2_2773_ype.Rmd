...
data<-read.csv("181126_tor2_2773_ype.csv")
...
f_plot<-function(melted_list){
  ...
  if(average==FALSE){ # for plotting raw or offset data
    plot<-ggplot()+
      ...
      geom_area(aes(x=10,y=10,fill="40")) +
      geom_area(aes(x=10,y=10,fill="50")) +
      ...
      scale_fill_manual(values=c("0"="gray90","15"="green","30"="gray50",
                                 "40"="purple","50"="orange","60"="black",
                                 "200"="blue", "600"="red")) +
...
f_save<-function(plot,name){
  ...
  print(plot)
  ggsave(filename=paste(name,".jpeg"),path="C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/nov18/181126_tor2_biolector_2773_ype",height=6, width=9.04, units = "cm")
}

f_save_pdf<-function(plot,name){
  
  print(plot)
  ggsave(filename=paste(name,".pdf"),path="C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/nov18/181126_tor2_biolector_2773_ype",height=6, width=9.04, units = "cm")
}
...
experiment_doses<-c(0,15,30,40,50,60,200,600) # all the doses in the experiment
...
tor2_final<-f_final_plot(list_melted_tor_dosed,c(0,15,30,50,200,600))
parent_final<-f_final_plot(list_melted_parent_dosed,c(0,15,30,50,200,600))
...
colour_palette_final<-c("#9AD2F4","#92ADDB","#898FC3","#857EAA","#72637A","black")
combined_final<-f_plot_combined(list_melted_tor_dosed,list_melted_parent_dosed,c(0,15,30,50,200,600),c(0,600))
