...
t0p1_file<-"180405_2opypethanol/ypethanol"
t1p1_file<-"180405_2opypethanol/ypethanol/controls"
pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/april18/180405_2opypethanol" # for saving plots
...
dfs_to_histogram<-c(1,2) # pick which strains you want to put in the histograms. 
doses_histogram<-experiment_doses
...
labels_histogram<-c("0","0.2","1","2","3","4","5","6","8","10","13","15","17","20","26",
                    "30","35","45","50","65","80","100","200","400","fry70","tdh3",
                    "no repressor") 
...
strains_to_include_histogram<-c(1,2)
...
names_individual_histograms<-c("histogram_gridpNF.jpeg","histogram_gridpAct1.jpeg"
                               ) # names for saving the plots
...
list_of_starting_points<-list(
  c(25000,0.1,30,10,1000),
  c(25000,0.5,30,2,1000)
)

time_point_sigmoid<-"36h"
height_sigmoid<-10
width_sigmoid<-15
...
# spearman
noise_dfs<-c(1,2)
noise_labels<-label_list[noise_dfs]
```
