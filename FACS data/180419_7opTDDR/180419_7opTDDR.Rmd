...
output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/april18/180419_7opTDDR" # for saving plots
...
descriptive_sequence<-c(1,5,9,13,17,21,25,29,33,37,41) #pick the strains at given timepoints
...
plot_title_smooth<-"Dose Response Curves, TDDR"
xlab_smooth<-xlabel
...
labels_histogram<-c("0","0.5","1","3","5","8","12","15","17","21","23","25","30",
                    "35","40","50","60","75","100","150","200","300","400","600",
...
list_of_starting_points<-list(
  ...
  c(30000,0.1,50,10,300),#6
  c(40000,0.1,50,10,300),#7
  c(40000,0.4,50,1,300),#8
