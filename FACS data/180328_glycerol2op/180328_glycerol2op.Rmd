...
t0p1_file<-"180328_2opmedia/gly"
t1p1_file<-"180328_2opmedia/gly/controls"
pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/march18/180328_glycerol2op/size_subset" # for saving plots
...
limit_fscw <-25000 #the value for subsetting based on FSC-W/H
limit_sscw <-50000 #the value for subsetting based on SSC-W/H
...
labels_histogram<-c("0","0.5","1","2","3","4","5","7","8","9","10",
                    "12","14","16","18","20","23","25","27","30","45","60","100","200","fry70","tdh3",
                    "no repressor") 
...
list_of_starting_points<-list(
  c(40000,0.05,16,10,2000),
  c(40000,0.5,9,1,2000)
)
