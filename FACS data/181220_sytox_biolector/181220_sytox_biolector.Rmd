...
t0p1_file<-"181220_biolector_sytox/p2/parent_ypd"
t0p2_file<-"181220_biolector_sytox/p2/tor2_ypd"
t0p3_file<-"181220_biolector_sytox/p2/pma1_sd"
t0p4_file<-"181220_biolector_sytox/p2/pma1_ypd"
t0p5_file<-"181220_biolector_sytox/p2/pbr1_ypd"
t0p6_file<-"181220_biolector_sytox/p2/whi5_ypd"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/2018/dec18/181218_sytox_biolector/sytox" # for saving plots
pattern_read<-""
...
f_sytox_plot<-function(dataframe, title, ylims, xlims){
  ...
  final_plot<- ggplot(dataframe) +
    ...
    geom_vline(aes(xintercept=10000), colour="black") +
    geom_vline(aes(xintercept=20000), colour="black") +
    geom_vline(aes(xintercept=30000), colour="black") +
    geom_vline(aes(xintercept=37000), colour="black") +
...
titles<-list("parent", "tor2","pma1_sd","pma1_ypd","pbr1","whi5")
...
whi5_df<-df_with_size[[6]]
parent_df<-df_with_size[[1]]

colour_scale<-scales::seq_gradient_pal("lightblue", "red", "Lab")(seq(0,1,length.out=8))

colnames(whi5_df)<-c("FSC-H","SSC-H","Stain","Dose","Size")
colnames(parent_df)<-c("FSC-H","SSC-H","Stain","Dose","Size")

ggplot(whi5_df)  +
  geom_density(aes(x=Size, colour=as.factor(Dose)), size= 1) +
  
  guides(colour=guide_legend(title="")) +
  xlab(expression(paste("Size x", 10^5, "(a.u.)", sep = ""))) +
  ylab(expression(paste("Density x", 10^-5, sep = ""))) +
  scale_x_continuous(limits=c(0,300000), breaks = c(0,100000,200000,300000), labels=c(0,1,2,3)) +
  scale_y_continuous(limits=c(0,NA), breaks = c(0,0.000005, 0.00001,0.000015), labels=c(0,0.5,1,1.5)) +
...
ggsave(filename = "whi5_size.jpeg", path = output_path, height=6, width=9.04, units="cm")
