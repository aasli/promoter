...
f_plot_sigmoid_curves<-
  ...
  function(fit_list,frame_list, control_list,control_list_sigmoid, ec_list, doses){
    ...
    final_plot<- 
      final_plot+
      geom_line(aes(x=c(0.1,experiment_doses[-1]),y=descriptives[[6]][1,1]), linetype="dotted")+
      geom_line(aes(x=c(0.1,experiment_doses[-1]),y=descriptives[[6]][24,1]), linetype="dotted")+
      geom_line(aes(x=c(0.1,experiment_doses[-1]),y=descriptives[[7]][1,1]), linetype="dotdash")+
      geom_line(aes(x=c(0.1,experiment_doses[-1]),y=descriptives[[7]][24,1]), linetype="dotdash") +
      geom_line(aes(x=c(0.1,experiment_doses[-1]),y=descriptives[[8]][1,1]), linetype="longdash") +
      geom_line(aes(x=c(0.1,experiment_doses[-1]),y=descriptives[[8]][24,1]), linetype="longdash") 
