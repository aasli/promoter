...
time_points<-c(-300,-270,-180,-90,seq(0,105,5),120)
...
f_time_lapse_plot<-function(dataframe, title, ylims, xlims){
  ...
  final_plot<- ggplot(dataframe) +
    ...
    geom_histogram(aes_(x=dataframe[,3]), colour="red", bins=100) +
...
time_lapse_plots[[1]]
 ...
 mapply(f_save,time_lapse_plots,paste(names(df_list),"small", sep="_"),
