...
t0p1_file<-"180404_nfvsact1/p1"
t1p1_file<-"180404_nfvsact1/p1/controls"
pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/april18/180404nfvsact1" # for saving plots
xlabel<-expression(paste("aTc[ng/mL]", sep = "")) 

starting_well<-1
wells_per_sample<-24

experiment_doses<- c(0,0.5,1,3,5,8,12,15,17,21,23,25,30,35,40,50,60,75,85,100,150,200,300,400)


columns_to_include<-c(3,6,7) #1=FSC-A, #2=FSC-H, #3=FSC-W, #4=SSC-A, #5=SSC-H, #6=SSC-W, #7= 488 [C]-H


strain_names<-c("2674","2741","2663","2661","2683","70") 
time_points<-c("6h")
...
labels_histogram<-c("0","0.5","1","3","5","8","12","15","17","21","23","25","30",
                    "35","40","50","60","75","85","100","150","200","300","400",
...
names_individual_histograms<-c("histogram_gridNF.jpeg","histogram_gridNF+Act1.jpeg",
                               "histogram_gridAct1.jpeg") # names for saving the plots
...
label_list_derivative<-c("NF","NF+pAct1","pAct1")
#----------------------------------------------------------------------------------------------------------
