...
t0p1_file<-"180329_2opgly/p1"
t1p1_file<-"180329_2opgly/p1/controls"
pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/march18/180329_glycerol2op" # for saving plots
...
labels_to_use<-c(1,2)
colour_palette<-c("red","blue", "orange","green","black","purple","pink","grey") # define the colour palette for plotting
