...
t0p1_file<-"180411_ffpcheck/p1"
t1p1_file<-"180411_ffpcheck/p1/controls"
...
experiment_doses<- doses= c(0,0.5,1,3,5,8,12,15,17,21,23,25,30,35,40,50,60,75,100,150,200,300,400,600)
...
list_of_starting_points<-list(
  c(30000,0.8,26,0.2,256),
  c(30000,0.8,30,0.2,2000),
  c(30000,0.8,20,0.2,256)
)
...
spearman_dfs<-c(1,2,3)
label_list_spearman<-label_list[[c(1:3)]]
#----------------------------------------------------------------------------------------------------------## QQPLOTS
