...
t0p1_file<-"180313_2opmedia/p2"
t1p1_file<-"180313_2opmedia/p2/controls"
pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/march18/180313_2op_proline" # for saving plots
xlabel<-expression(paste("aTc[ng/mL]", sep = "")) 

starting_well<-1
wells_per_sample<-24

experiment_doses<-c(0,0.2,0.5,0.7,1,1.5,2,2.5,3,4,5,6,7,8,10,12,15,20,25,30,40,45,60,200)
...
labels_to_use<-c(1,2)
colour_palette<-c("red","blue", "orange","green","black", "pink", "purple","firebrick") # define the colour palette for plotting
