...
t0p1_file<-"IPL1_checks/181016"
t0p2_file<-"IPL1_checks/181017"
t0p3_file<-"IPL1_checks/181018"

output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/oct18/IPL1_checks" # for saving plots
pattern_read<-""
...
ylims<-list(c(0,125),c(0,200),c(0,100))
xlims<-list(c(0,50000),c(0,100000),c(0,100000))

titles<-list("glycerol","atc", "atc_gradient")
