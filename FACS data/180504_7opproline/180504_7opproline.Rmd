...
lower_limit_fscw <-12500 #the value for subsetting based on FSC-W/H, lower limit
...
number<-5
p<-subset(df_with_size[[number]],df_with_size[[number]][,4]==600)


ggplot() +
  geom_point(aes(x=p[,5],y=p[,3]))
