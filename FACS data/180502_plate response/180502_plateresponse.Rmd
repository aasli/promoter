...
t0p1_file<-"180502_plateresponse/p1"
t1p1_file<-"180502_plateresponse/p1/controls"
pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/may18/180502_plateresponse" # for saving plots
xlabel<-expression(paste("aTc[ng/mL]", sep = "")) 

starting_well<-1
wells_per_sample<-11

experiment_doses<-c(0,20,40,80,100,400,1000,5000,10000,15000,30000)


columns_to_include<-c(2,5,7) #1=FSC-A, #2=FSC-H, #3=FSC-W, #4=SSC-A, #5=SSC-H, #6=SSC-W, #7= 488 [C]-H


strain_names<-c("2759 ypd","2759 sd","70plate","2661plate","70liquid","2661liquid") 
time_points<-c("2days")

label_list<- c("final system, ypd",
               "final system, sd",
               "fry70plate",
               "no repressor, plate",
               "fry70 liquid",
...
plot_title<-"Dose Response Curves, 2days"
