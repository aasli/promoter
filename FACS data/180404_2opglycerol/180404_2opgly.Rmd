...
t0p1_file<-"180404_2opgly/36h"
t1p1_file<-"180404_2opgly/36h/controls"
pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/april18/180404_2opglycerol" # for saving plots
xlabel<-expression(paste("aTc[ng/mL]", sep = "")) 

starting_well<-1
wells_per_sample<-23

experiment_doses<-c(0,0.5,1,2,3,4,5,7,8,9,10,12,14,16,18,20,23,25,27,30,45,60,100)
...
labels_histogram<-c("0","0.5","1","2","3","4","5","7","8","9","10","12","14","16",
                    "18","20","23","25","27","30","45","60","100","fry70","tdh3",
                    "no repressor") 
...
list_of_starting_points<-list(
  c(20000,0.5,30,0.1,1000),
  c(20000,0.5,10,0.1,1000)
)
