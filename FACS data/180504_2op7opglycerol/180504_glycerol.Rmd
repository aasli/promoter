...
t1p1_file<-"180504_media/glycerol25halfh"
t1p2_file<-"180504_media/glycerol25halfh/controls"


pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/may18/180504_glycerol" # for saving plots
...
strain_names<-c("2561","2759","2551","2683","70","2661") 
time_points<-c("26h")
...
plot_title_smooth<-"Dose Response Curves, 26h"
xlab_smooth<-xlabel
...
labels_histogram<-c(0,0.2,0.5,1,2,4,5,7,8,10,12,14,16,18,20,25,27,30,45,60,100,200,400,600,
...
labels_to_use<-c(1,2)
colour_palette<-c("red","blue", "orange","green","black","pink","navy","lightblue","grey") # define the colour palette for plotting
# define the plot title, xlabel
plot_title<-"Dose Response Curves, 25.5h"
xlabel<-expression(paste("aTc[ng/mL]"))

# pick controls for the plot
controls_to_use_sigmoid<-c(3,4,5,6)
...
list_of_starting_points<-list(
  c(30000,0.05,20,10,3000),
  c(30000,0.05,20,10,300)
  
  )

time_point_sigmoid<-"25.5h"
height_sigmoid<-10
width_sigmoid<-15

## derivative of sigmoid fit

label_list_derivative<-c("NF,2op","NF7op")
#----------------------------------------------------------------------------------------------------------
