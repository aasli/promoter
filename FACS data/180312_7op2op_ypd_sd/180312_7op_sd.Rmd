...
t0p1_file<-"180312_7op2op_ypd_sd/7op_ypd_sd/sd"
t1p1_file<-"180312_7op2op_ypd_sd/7op_ypd_sd/sd/controls"
pattern_read<-"Specimen_001"


output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/plots/march18/180312_7op2op_ypd_sd/7op_sd" # for saving plots
...
strain_names<-c("2733","2661","2683","70") # all of them are just one strain, FRY2561
time_points<-c("6h")
...
descriptive_sequence<-c(1) #pick the strains at given timepoints
label_list_smooth<-label_list[c(1)]
timepoint_used<-1
...
labels_histogram<-c("0","0.2","1","3","4","5","7","10","13","17","23","30","40",
                    "50","70","100","130","150","180","200","250","300","350","400","fry70","tdh3",
                    "no repressor") 
