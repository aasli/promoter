...
df_list<-c(f_df_list(t0p1,starting_well,7,c("0","90","180","270","360","21h","54h"),columns_to_include),
           f_df_list(t0p2,starting_well,4,c("0","360min","21h","54h"),columns_to_include),
           f_df_list(t0p3,starting_well,6,c("0","90","180","270","360","21h"),columns_to_include),
           f_df_list(t0p4,starting_well,3,c("0","360min","21h"),columns_to_include),
           f_df_list(t0p5,starting_well,3,c("0","360min","21h"),columns_to_include),
           f_df_list(t0p6,starting_well,1,"0",columns_to_include)
           )
...
df_list_names<-c("2772","2772_atc","2776","2776_atc","2769","2781","2769Nstaved")
