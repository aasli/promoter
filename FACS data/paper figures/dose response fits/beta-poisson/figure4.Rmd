...
output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/paper/figures/beta_poisson" # for saving plots
...
list_of_starting_points<-list(
  c(0.1,100,10000,300,300), #1
  c(1,100,10000,300,300),#2
  c(1,100,10000,300,300),#3
  c(1,100,30000,300,300),#4
  c(1,100,30000,300,300),#5
  c(1,100,30000,300,300),#6
  c(1,100,30000,300,300),#7
  c(1,100,40000,300,300),#8
  c(1,100,40000,300,300),#9
  c(1,100,40000,300,300)#10
)
...
function_curve_fitting<-
  ...
  function(frame,list_of_starting_points,print){
    ...
    # fitting
    fitmodel <- nlsLM(y ~  (c - (d + (x/b))^(-a)), start=list(a=a,b=b, c=c, d=d), 
...
f_sigmoid <- function(params, x) {
  params[[3]] -  ((params[[4]] + (x/params[[2]]))^(-params[[1]])) 
