...
output_path<-"C:/Users/aslia/Desktop/pisi/ETH/master project/labbook/paper/figures/double_asymmetry" # for saving plots
...
list_of_starting_points<-list(
  c(300,10000,0.1,30,10000,1,30), #1
  c(300,10000,0.1,30,10000,1,30),#2
  c(300,10000,0.5,30,10000,0.5,30),#3
  c(300,10000,0.5,30,10000,0.5,30),#4
  c(300,10000,0.5,30,10000,0.5,30),#5
  c(300,10000,0.5,30,10000,0.5,30),#6
  c(300,10000,0.5,30,10000,0.5,30),#7
  c(300,10000,0.5,30,10000,0.5,30),#8
  c(300,10000,0.5,30,10000,0.5,30),#9
  c(300,10000,0.5,30,10000,0.5,30)#10
)
...
function_curve_fitting<-
  ...
  function(frame,list_of_starting_points,print){
    ...
    f<-list_of_starting_points[[6]]
    g<-list_of_starting_points[[7]]
    # fitting
    fitmodel <- nlsLM(y ~  (a + (b/(1+exp(c*(d-x)))) + (e/(1+exp(f*(g-x)))) ), start=list(a=a,b=b, c=c, d=d, e=e,
                                                                                            f=f,g=g),
...
f_sigmoid <- function(params, x) {
  (params[[1]] + (params[[2]]/(1+exp(params[[3]]*(params[[4]]-x)))) + (params[[5]]/(1+exp(params[[6]]*(params[[7]]-x))))) 
