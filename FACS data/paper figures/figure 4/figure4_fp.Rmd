...
f_vs_size_plots<-lapply(df_with_size[c(1,descriptives_to_use_sigmoid)],f_size_vs_fluorescence, c(0,5,23,60,200,600))


mapply(f_save, f_vs_size_plots, names(df_list)[c(1,descriptives_to_use_sigmoid)], 
       MoreArgs = list(output_path,"f_vs_size", 6, 9.04) ,SIMPLIFY = F)
